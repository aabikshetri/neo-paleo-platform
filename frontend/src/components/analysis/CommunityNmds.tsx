              ...
              layout={{
                ...
                ...(result.dimensions === 3 ? {
                  scene: {
                    ...
                    xaxis: { title: { text: "NMDS1" }, showgrid: true, showbackground: false, zeroline: false },
                    yaxis: { title: { text: "NMDS2" }, showgrid: true, showbackground: false, zeroline: false },
                    zaxis: { title: { text: "NMDS3" }, showgrid: true, showbackground: false, zeroline: false },
                  },
                } : {
              ...
              <Suspense fallback={<p>Loading diagnostic…</p>}>
                <Plot
                  ...
                  layout={{
                    ...
                    xaxis: { title: { text: "Bray–Curtis dissimilarity" }, zeroline: false, gridcolor: "rgba(148,163,184,0.18)" },
                    yaxis: { title: { text: "Ordination distance" }, zeroline: false, gridcolor: "rgba(148,163,184,0.18)" },
                    paper_bgcolor: "transparent",
                    plot_bgcolor: "transparent",
